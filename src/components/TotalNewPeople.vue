<template>
    <div class="widget widget-one_hybrid widget-referral">
        ...
        <div class="widget-content">
            <div class="w-chart">
                <div id="chart-total-new-people"></div>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        async init() {
            const result = await superagent.get(`${API_ENDPOINT}/stats/people`)
        ...
        drawGraph() {
            const options = {
                ...
                series: [{
                    name: 'People',
                    data: [ 160, 228, 352, 538, 888, 1212, this.total ]
                }],
            ...
            const chart = new ApexCharts(
                document.querySelector('#chart-total-new-people'), options)
