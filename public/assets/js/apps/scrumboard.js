                        ...
                        '<div class="task-container-header">'+
                            ...
                            '<div class="dropdown">'+
                                ...
                                '<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink-4">'+
                                    '<a class="dropdown-item list-edit" href="javascript://">Edit</a>'+
                                    '<a class="dropdown-item list-delete" href="javascript://">Delete</a>'+
                                    '<a class="dropdown-item list-clear-all" href="javascript://">Clear All</a>'+
                                '</div>'+
                            '</div>'+
                        '</div>'+
