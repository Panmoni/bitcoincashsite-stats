                        ...
                        '<div class="note-footer">' +
                            '<div class="tags-selector btn-group">' +
                                ...
                                '<div class="dropdown-menu dropdown-menu-right d-icon-menu">' +
                                    '<a class="note-personal label-group-item label-personal dropdown-item position-relative g-dot-personal" href="javascript://"> Personal</a>' +
                                    '<a class="note-work label-group-item label-work dropdown-item position-relative g-dot-work" href="javascript://"> Work</a>' +
                                    '<a class="note-social label-group-item label-social dropdown-item position-relative g-dot-social" href="javascript://"> Social</a>' +
                                    '<a class="note-important label-group-item label-important dropdown-item position-relative g-dot-important" href="javascript://"> Important</a>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
                    '</div>' +
